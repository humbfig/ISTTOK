...
class isttok:
    ...
    def get_data(self):
        ...
        self.tStart = dataStruct.getTStart().getTimeInMicros()
        self.tEnd = dataStruct.getTEnd().getTimeInMicros()
        len_d = len(data)
        self.tbs = (self.tEnd - self.tStart) / len_d
